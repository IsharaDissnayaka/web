    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href="#domain" className="hover:text-blue-400 transition-colors duration-200">Domain</a>
          <a href="#achievements" className="hover:text-blue-400 transition-colors duration-200">Achievements</a>
      ...
      <div className="flex items-center gap-4">
        ...
        <a href="https://github.com/Nipun44/ManthraX" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
          <FaGithub size={22} />
        </a>
