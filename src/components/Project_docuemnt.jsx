...
import thesisPDF from "../assets/pdf/24-25J-213_Group_Final_Report.pdf";
...
import businessPDF from "../assets/pdf/Business Plan for MANTHRA.pdf";

const docs = [

  {
    title: "Topic Assesment Form",
    desc: "Contains the details of the project topic and the components.",
    pdf: studentDocPDF,
    icon: "👨‍🎓",
